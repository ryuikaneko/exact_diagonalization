...
def make_hamiltonian(list_Hx,list_Jzz,list_isite0,list_isite1,list_isite2,N,Nint1,Nint2,Nhilbert):
    def get_vec(vec):
#        vecnew = np.zeros(Nhilbert,dtype=complex)
        vecnew = np.zeros(Nhilbert,dtype=float)
...
def main():
    ...
    start = time.time()
    get_vec = make_hamiltonian(list_Hx,list_Jzz,list_isite0,list_isite1,list_isite2,N,Nint1,Nint2,Nhilbert)
