...
#    parser.add_argument('-J4', metavar='J4',dest='J4', type=float, default=1.0, help='set J4')
    parser.add_argument('-TBC', metavar='TBC',dest='TBC', type=int, default=1, help='set twisted BC (TBC=1)')
...
def make_interaction_list(N,Jleg_xx,Jleg_zz,Jrung_xx,Jrung_zz,J4_xx,J4_zz,J4_xz,TBC):
#
# 0-2-4- ... -  2*i  - 2*i+2 - ...
# | | |          |       | 
# 1-3-5- ... - 2*i+1 - 2*i+3 - ...
...
#    Lx = N//2
    ...
    Nbond1, Nbond2, \
        ...
        list_Jxx, list_Jzz, \
        list_J4xx, list_J4zz, list_J4xz \
        = make_interaction_list(N,Jleg_xx,Jleg_zz,Jrung_xx,Jrung_zz,J4_xx,J4_zz,J4_xz,TBC)
...
#    print("# Nsite, energy per site:",N,' '.join(map(str,ene)))
    print("Nsite, Jleg, Jrung, Jising, J4, BC, energy:",\
        N,Jleg,Jrung,Jising,J4,TBC,str(ene).lstrip('[').rstrip(']'))
    print("Nsite, Jleg, Jrung, Jising, J4, BC, gap:",\
        N,Jleg,Jrung,Jising,J4,TBC,str(ene-ene[0]).lstrip('[').rstrip(']'))
